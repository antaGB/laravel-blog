...
@section('container')
  ...
  @if ($posts->count())
    <div class="card mb-3">
      <div class="position-absolute mt-2 ms-2 px-3 py-2 badge bg-secondary"><a href="/posts?category={{ $posts[0]->category->slug }}" class="text-decoration-none text-light">{{ $posts[0]->category->name }}</a></div>
    ...
    <div class="container">
      <div class="row">
        @foreach ($posts->skip(1) as $post)
          <div class="col-md-4">
            <div class="card mb-3">
              <div class="position-absolute mt-2 ms-2 px-3 py-2 badge bg-secondary"><a href="/posts?category={{ $post->category->slug }}" class="text-decoration-none text-light">{{ $post->category->name }}</a></div>
